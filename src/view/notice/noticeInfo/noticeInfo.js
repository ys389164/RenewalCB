...
const dataBinding = () => {
    ...
    path.innerHTML = `<p><a href="../notice.html">home</a> &gt; <a href="../notice.html">notice</a> &gt; ${menuInfo.tab}</p>`
...
const bindingTypeOne = () => {
    ...
    for(let x=0; x<menuInfo.imgUrl.length; x++){
        notice.innerHTML += menuInfo.imgUrl[x]
        notice.innerHTML += menuInfo.notice[x] || ''
    }
}
